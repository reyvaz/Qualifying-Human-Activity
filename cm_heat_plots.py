    ...
    for x in range(width):
        for y in range(height):
            ...
            ax.annotate(cell_text, xy=(y, x), 
                    ...
                    fontweight = 'bold' if cm[x,y] > 0 else "normal", size=11,
...
def side_by_side(cm, cm_normalized, cm_color_vals, cmap, labels, plot_title):
    """
    ...
    fig.suptitle(plot_title, fontweight = 'bold', size=18)  
...
def one_plot(cm, cm_normalized, cm_color_vals, cmap, annotation, 
    ...
    ticks_labels_title(ax, labels)
    plt.title(plot_title, fontweight = 'bold', size=18)  
    plt.tight_layout()
    return None
...
def heated_confusion_matrix(cm, labels, annotation = "both", 
    ...
    if by_side is False:
        ...
        side_by_side(cm, cm_normalized, cm_color_vals, cmap, labels, plot_title)
